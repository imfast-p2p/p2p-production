...
import { FaFolderPlus, FaInfoCircle, FaTimesCircle, FaAngleLeft } from "react-icons/fa";
...
class Borrow extends Component {
    constructor() {
        ...
        this.state = {
            email: '',
            mobilenumber: sessionStorage.getItem('mobileno'),
            pannumber: '',
            otpm: '',
            otpe: '',
            dateofbirth: "",
            gender: sessionStorage.getItem('Digi_gender'),
            utype: sessionStorage.getItem('DigiUserType'),
            name: sessionStorage.getItem('username'),
            loginpassword: '',
            changeLoginpassword: '',
            emailref: "",
            mobileref: "",
            panInfo: sessionStorage.getItem('pan'),
    ...
    componentDidMount() {
        ...
        console.log(sessionStorage.getItem('DigiUserType'))
        var usertypeLocal = sessionStorage.getItem('DigiUserType')
        this.setState({ utype: usertypeLocal })
        console.log(this.state.dateofbirth)
        ...
        } else if (this.state.gender == "OTHERS") {
    ...
    utype(event) {
        ...
        if (event.target.value == "Lender") {
            ...
            // this.setState({ aggrement: "Facilitator Agreement." })
    ...
    pannumber(event) {
        this.setState({ panInfo: event.target.value.toUpperCase().trim() })
    ...
    register(event) {
        // var finalDOB=this.state.dateofbirth;
        // var finalreverse = finalDOB.split("-").reverse().join("-");
        // console.log(finalreverse)
        // this.setState({ dateofbirth: finalreverse })
        console.log(this.state.dateofbirth)
        ...
        if (this.state.userInfo) {
            var selfReg = JSON.stringify({
                ...
                regmode: 2,
                refid: sessionStorage.getItem("reference_id"),
                    ...
                    <div className='modal-dialog modal-dialog-centered'>
                        <div className='modal-content'>
                            <div className='modal-body' style={{ overflow: "scroll" }} id='secondAuditScroll12'>
                                ...
                                <p className='risk-rating-header' style={{ color: "rgb(0, 38, 77)" }}>Registration Process :</p>
                                ...
                                <p className='risk-rating-header' style={{ color: "rgb(0, 38, 77)" }}>After Login :</p>
                                <ul className='timeline'>
                                    <li className='timeline-item'>
                                        <span className='timeline-label'>Add Personal Details:</span>
                                        <span className='timeline-description'>Complete your personal information.</span>
                                    </li>
                                    <li className='timeline-item'>
                    ...
                    <Row>
                        <Col>
                            <Card className="" style={{ maxWidth: "700px", marginLeft: "8px", paddingBottom: "10px", cursor: "default" }}>
                                ...
                                <div className="row" style={{ padding: "0px 20px" }}>
                                    <button className=" btn col-12 justify-center" style={{ display: "none", backgroundColor: "#0079bf", color: "white" }} id="sig" onClick={this.register}>Sign Up</button>
                                </div>
                            </Card>
                        </Col>
                    </Row>
...
export default withTranslation()(Borrow);
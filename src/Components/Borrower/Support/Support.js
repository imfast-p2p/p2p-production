...
export class Support extends Component {
    ...
    issueDesc = (event) => {
        ...
        var isValid = true;
        this.setState({ issuedesc: username });
        ...
        if (isValid) {
            ...
            $("#raisetktbtn").prop('disabled', false);
        } else {
            this.setState({
                issueDescFlag: true
            });
            $("#raisetktbtn").prop('disabled', true);
        }
    }
    issueStatus = (event) => {
    ...
    //         document.getElementById('user_captcha_input').value = '';
    //         this.setState.captchaState = false;
    //     }
    // };
    getIssuTypes = () => {
        ...
        fetch(BASEURL + '/usrmgmt/closemyaccount', {
            ...
            .then((resdata) => {
                ...
                if (resdata.status === 'Success' || resdata.status === 'SUCCESS') {
                    ...
                    if (!resdata.msgdata || !resdata.msgdata.otpref) {
                    ...
                    } else if (resdata && resdata.msgdata && resdata.msgdata.otpref) {
                        $("#textContent").hide()
                        $("#otpContent").show()
                        this.setState({
                    ...
                    <div className="container-fluid row pt-2">
                        ...
                        <div className='col-5' id="" style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / Support</p>
                        </div>
                        <div className='col'>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                >
                                    ...
                                    <li class="nav-item mb-2" onClick={this.getsupportTickets}>
                                            ...
                                            <div className="card-header border-1 bg-white">
                                                ...
                                                <div className='row mb-2'>
                                                    ...
                                                    <div className='col-6 paymentRelatedTag' style={{ display: "none" }}>
                                                        ...
                                                        {this.state.bankrefFlag === false ? <span className='text-danger' style={{ fontSize: "12px" }}><BsInfoCircle />Please enter a valid bank reference number.</span> : ""}
                                                    </div>
                                                </div>
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    ...
                                                    <div className='col-6'>
                                                        ...
                                                        {this.state.isPaymentDateValid === false ? <span className='text-danger' style={{ fontSize: "12px" }}><BsInfoCircle />Future date can not be selected as payment date</span> : ""}
                                                    </div>
                                                </div>
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    <div className='col-6'>
                                                    ...
                                                    <div className="form-group col-md-6">
                                                        ...
                                                        <input className='form-control' type='number' placeholder='Enter Amount' style={{ marginTop: "-12px" }} onChange={this.Amount} />
                                                        {this.state.isAmountValid === false ? <span className='text-danger' style={{ fontSize: "12px" }}><BsInfoCircle />Please enter a valid amount.</span> : ""}
                                                    </div>
                                                </div>
                                                <div className="row mb-2">
                                                    <div className='col-6 paymentRelatedTag' style={{ display: "none" }}>
                                                    ...
                                                    <div className={(paymentRelFlag?.includes("PY") ? 'col-6' : 'col')}>
                                                        <p htmlFor="Desc" id='reason' style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", width: "320px" }}>{t('User Description (Maximum 1000 words) *')}</p>
                                                        ...
                                                        {this.state.issueDescFlag ? <span className='text-danger' style={{ fontSize: "12px" }}><BsInfoCircle />Provide a valid description</span> : ""}
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="view-ticket" role="tabpanel" aria-labelledby="viewTicket-tab">
                                        <div className="card" style={{ cursor: "default" }}>
                                            <div className="card-header border-1 bg-white">
                                                ...
                                                {this.state.dateError && <span className='text-danger' style={{ fontSize: "12px" }}><BsInfoCircle />To Date cannot be less than From Date</span>}
                                                                            ...
                                                                            <div className='card p-3' style={{ border: "2px solid rgb(183, 214, 232)", marginBottom: "1px", cursor: "default" }}>
                                                                                <div className='row' style={{ fontSize: "14px", color: "#222C70" }}>
                                                                                    ...
                                                                                    <div className='col-6' style={{ marginTop: "-30px" }}>
                                                                                        <p className="font-weight-bold" style={{ marginBottom: "1px" }}>Issue Name</p>
                                                                                        {/* <p>{tLists.issuename == "" || null ? "-" : tLists.issuename}</p> */}
                                                                                        ...
                                                                                        {/* <p>{tLists.issuedesc == "" || null ? "-" : tLists.issuedesc}</p> */}

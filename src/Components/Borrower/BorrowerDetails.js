...
import $ from 'jquery';
import BorrowerSidebar from '../../SidebarFiles/BorrowerSidebar';//updated
...
import EditBorPersonalDetails from './EditBorPersonalDetails';
// import EditBorAddressDetails from './EditBorAddressDetails';
import EditBorBankDetails from './EditBorBankDetails';
...
export class BorrowerDetails extends Component {
        ...
        fetch(BASEURL + '/usrmgmt/getpersonaldetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    sessionStorage.setItem("B_mobile", this.state.pmobile);
                }
                else {
                    // this.setState({ showLoader: false })
        ...
        fetch(BASEURL + '/usrmgmt/getaccountdetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    sessionStorage.setItem('loanaccNo', resdata.msgdata.accountno)
    ...
    componentDidMount() {
        if (sessionStorage.getItem('isLogin') == "true") {
            ...
            this.onSelectOption();
            console.log(sessionStorage.getItem("B_mobile"));
            ...
            $("#BbtnuserDetails").click(function () {
                $("#BuserDetails1").hide();
                $("#BuserDetails2").hide();
                $("#BuserDetails3").hide();
                $("#BbtnuserDetails").hide();

                $("#Buserdetails4").show();

            })
            $("#BuserdetailBtn").click(function () {
                $("#BuserDetails1").show();
                $("#BuserDetails2").show();
                $("#BuserDetails3").show();
                $("#BbtnuserDetails").show();

                $("#Buserdetails4").hide();

            })
            $("#BbtnAddressdetails").click(function () {
                $("#Baddressdetails0").hide();
                $("#Baddressdetails1").hide();
                $("#Baddressdetails2").hide();
                $("#Baddressdetails3").hide();
                $("#Baddressdetails4").hide();
                $("#Baddressdetails5").hide();
                $("#Baddressdetails6").hide();
                $("#BbtnAddressdetails").hide();

                $("#Baddressdetails7").show();
            })
            $("#BaddressdetailBtn").click(function () {
                $("#Baddressdetails0").show();
                $("#Baddressdetails1").show();
                $("#Baddressdetails2").show();
                $("#Baddressdetails3").show();
                $("#Baddressdetails4").show();
                $("#Baddressdetails5").show();
                $("#Baddressdetails6").show();
                $("#BbtnAddressdetails").show();

                $("#Baddressdetails7").hide();
            })

            $("#BbtnBankdetails").click(function () {
                $("#Bbankdetails0").hide();
                $("#Bbankdetails1").hide();
                $("#Bbankdetails2").hide();
                $("#Bbankdetails3").hide();
                $("#BbtnBankdetails").hide();

                $("#Bbankdetails4").show();

            })
            $("#BbankdetailBtn").click(function () {
                $("#Bbankdetails0").show();
                $("#Bbankdetails1").show();
                $("#Bbankdetails2").show();
                $("#Bbankdetails3").show();
                $("#BbtnBankdetails").show();
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    responseData.find(ele => {
                        ...
                        // else if (userType == 3 && docuType == 10) {
                        //     console.log(userType, docuType)
                        //     console.log(addDocuId, addDocLocation, addDocName)
    ...
    renderFormElement = (element, index) => {
        ...
        switch (element.datatype) {
            case "text":
                return (
                    <div key={element.datatype + index} className="col-6 mb-2" style={{ fontSize: "14px" }}>
                        <p className="label" style={{ marginBottom: "5px", color: "rgba(5,54,82,1)", fontWeight: "600" }}>{element.label} *</p>
            ...
            case "numeric":
                return (
                    <div key={element.datatype} className="col-6 mb-2" style={{ fontSize: "14px" }}>
                        <p className="label" style={{ marginBottom: "5px", color: "rgba(5,54,82,1)", fontWeight: "600" }}>{element.label} *</p>
                        <input className="form-control"
                            style={{ border: "1px solid rgb(0, 121, 190)" }}
                            maxLength={element.maxlength}
            ...
            case "date":
                return (
                    <div key={element.datatype + index} className="form-group col-6 mb-2" style={{ fontSize: "14px" }}>
                        <p className="label" style={{ marginBottom: "5px", color: "rgba(5,54,82,1)", fontWeight: "600" }}>{element.label} *</p>
                        <input
                            type="date" className="form-control"
                            name={element.name}
    ...
    viewPOAImage = (list) => {
        var pDocsId = list.id
        var memmid = sessionStorage.getItem('memmID')
        var docuName = this.state.poadocsNum;
        console.log(this.state.pdocsID)
        fetch(BASEURL + `/usrmgmt/getdocument?id=${pDocsId}` + `&memmid=${memmid}`, {
            method: 'Get',
            headers: {
    ...
    getBorrTnc = (event) => {
        fetch(BASEURL + `/usrmgmt/getplatformdocinfo?docid=BOR-TNC`, {
            method: "GET",
        })
            .then((Response) => Response.json())
            .then((resdata) => {
                if (resdata.status === "Success") {
                    ...
                    if (Id == "BOR-TNC") {
                        ...
                        document.getElementsByClassName('PDFdocBor')[0].src = uri + "#zoom=90";
                        $("#borDeclaration").click()
                    }
                }
            })
    }
    ...
    render() {
        ...
        const { permanentAddressStatus, permNewAddressStatus, ovdMasterList, isEntityFlag, errors } = this.state;
            ...
            <div className="container-dashboard d-flex flex-row" id="wrapper" style={{ marginTop: "-7px", backgroundColor: "#f4f7fc" }}>
                ...
                <div className="main-content" id="page-content-wrapper">
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-4' id="BnavRes2" style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / Profile Details</p>
                        </div>
                        <div className='col'>
                    ...
                    <div className='row ' style={{ marginTop: "-15px" }}>
                        <div className="col">
                            <p className="d-flex justify-content-center" style={{ fontWeight: "bold", fontSize: "16px", color: "rgba(5,54,82,1)" }}>{t('View Profile')}</p>
                        </div>
                    </div>
                        ...
                        <Col>
                            <Card className="" style={{ width: "963px", marginLeft: "50px", paddingBottom: "10px", cursor: "default", color: "rgba(5,54,82,1)", fontSize: "14px" }}>
                                <div className='row' style={{ marginTop: "-10px" }}>
                                    <div className='col'>
                                        <div className='' id='personalCard' style={{
                                            borderRadius: "16px", backgroundColor: "rgba(240,249,255,1)",
                                            position: "relative", zIndex: "1", cursor: "default", height: "fit-content"
                                        }}>
                                            <div className='row item-list align-items-center' style={{ marginTop: "15px" }}>
                                                <div >
                                                    <div className="row">
                                                        <div className='col-lg-2 col-md-3 col-sm-12' id="imgCol">
                                                            {this.state.image ?
                                                        ...
                                                        <div className='col-lg-10 col-md-5 col-sm-6' id="pdetail1Col">
                                                            <p style={{ fontWeight: "bold", fontSize: "14px", color: "RGBA(5,54,82,1)", marginLeft: "15px" }}>{this.state.pname}</p>
                                                            <div className='row'>
                                                                <div className='col'>
                                                                    <div className='col-md-12 col-sm-12'>
                                                                        <p style={{ fontSize: "14px", color: "RGBA(5,54,82,1)" }}><span style={{ fontWeight: "bold" }}>{t('Email')}</span>
                                                                    ...
                                                                    <div className='col-md-12 col-sm-12'>
                                                                        <p style={{ fontSize: "14px", color: "RGBA(5,54,82,1)" }}><span style={{ fontWeight: "bold" }}>{t('Gender')}</span>
                                                                ...
                                                                <div className='col'>
                                                                    <div className='col-md-12 col-sm-12'>
                                                                        <p style={{ fontSize: "14px", color: "RGBA(5,54,82,1)" }}><span style={{ fontWeight: "bold" }}>{t('Contact')}</span>
                                                                    ...
                                                                    <div className='col-md-12 col-sm-12'>
                                                                        <p style={{ fontSize: "14px", color: "RGBA(5,54,82,1)" }}><span style={{ fontWeight: "bold" }}>{t('Date Of Birth')}</span>
                                                ...
                                                <div className='row' style={{ marginTop: "-20px" }}>
                                                    <div className='col' style={{ textAlign: "end" }}>
                                                        <p className="" id='' style={{ cursor: "pointer", fontWeight: "500",  fontSize: "14px" }} onClick={this.getBorrTnc}>
                                                            Borrower Declaration &nbsp; <FaFileAlt style={{ marginTop: "-4px" }} />
                                                        </p>
                                                    </div>
                                                </div> */}
                                                        ...
                                                        <div className='col-lg-6 col-md-8 col-sm-12' style={{ paddingLeft: "33px" }}>
                                                            {accountDetails == 1 && (kycVerification == 1 || kycVerification == 9) && personalDetails == 1 && isTnCSigned == 1 ?
                                                                <p className="downloadTnc" id='downloadTnCid' style={{ cursor: "pointer", fontWeight: "500", fontSize: "14px", marginRight: "12px" }} onClick={this.viewDocument}>
                                                                    {t('Download')}  {TnC} <FaFileDownload style={{ marginTop: "-4px" }} />
                                                                </p> :
                                                                accountDetails == 1 && (kycVerification == 1 || kycVerification == 9) && personalDetails == 1 && isTnCSigned == 0 &&
                                                                <p style={{ color: "#222c70", fontWeight: "400", fontSize: "14px" }} onClick={this.retriggerTnCSigning}>
                                                                    {t('Request for')} {TnC} {t('Signing *')} &nbsp; <button className='btn btn-sm text-white' style={{ backgroundColor: "#0079bf" }}><FaFileSignature />&nbsp;{TnC} {t('Sign')}</button>
                                                                </p>
                                                            }
                                                        </div>
                                                        <div className='col-lg-6 col-md-4 col-sm-5' style={{ textAlign: "end" }}>
                                                            <p className="" id='' style={{ cursor: "pointer", fontWeight: "500", fontSize: "14px", marginRight: "10px", color: "#0079bf" }} onClick={this.getBorrTnc}>
                                                                {t('Borrower Declaration')} <FaFileAlt style={{ marginTop: "-4px" }} />
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div className='row' style={{ marginTop: "10px" }}>
                                    <div className='col'>
                                        <ul role="tablist" className="nav nav-pills nav-fill mb-3" style={{ fontSize: "15px", whiteSpace: "nowrap", overflowX: "scroll", display: "flex", flexDirection: "row", flexWrap: "nowrap", scrollbarColor: " rgb(40, 116, 166) white", scrollbarWidth: "thin" }}>
                                            <li className="nav-item"> <a data-toggle="pill" id='detailsTab' href="#user-details" className="nav-link active detailsTab"
                                                style={{ textAlign: "initial" }}>{t('Personal Details')} </a> </li>
                                            {isEntityFlag !== "1" &&
                                                <li className="nav-item"> <a data-toggle="pill" id='detailsTab' href="#address-details" className="nav-link detailsTab"
                                                    onClick={this.getAddressDetails}> {t('Address Details')} </a> </li>
                                            }
                                            <li className="nav-item"> <a data-toggle="pill" id='detailsTab' href="#bank-details" className="nav-link detailsTab"
                                                onClick={this.getBankDetails}> {t('Bank Details')} </a> </li>
                                            {isEntityFlag !== "1" &&
                                                <li className="nav-item"> <a data-toggle="pill" id='detailsTab' href="#kyc-documents" className="nav-link detailsTab"
                                                    style={{ textAlign: "center" }} onClick={this.getDocumentDetails}>{t('Verification')}</a> </li>
                                            }
                                            <li className="nav-item"> <a data-toggle="pill" id='detailsTab' href="#ovd-documents" className="nav-link detailsTab"
                                                style={{ textAlign: "end" }} onClick={this.getUploadedOvds}>{t('Documents')}</a> </li>
                                            {/* entity updated */}
                                            {isEntityFlag === "1" &&
                                            ...
                                            }
                                            {
                                                this.state.setMPINFlag == true ?
                                                    <li className="nav-item"> <a data-toggle="pill" href="#set-pin" className="nav-link detailsTab"
                                                        style={{ textAlign: "end" }} >{t('PIN Management')}</a> </li>
                                                    : ""
                                            }
                                        </ul>
                                        ...
                                        <div className='tab-content' style={{ backgroundColor: "rgb(240, 249, 255)" }}>
                                            <div id="user-details" className=" register-form tab-pane fade show active" style={{ padding: '30px', cursor: "default" }}>
                                                <div className="row" style={{ marginTop: "-20px", fontSize: "14px" }}>
                                                    <div className='col-lg-10 col-md-6 col-sm-5' id="BuserDetails1" style={{ fontFamily: "Poppins,sans-serif", fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                        <FaRegUser style={{ marginTop: "-6px" }} />&nbsp;<span>{t('Personal Info')}</span>
                                                        <hr style={{ marginTop: "1px" }} />
                                                    </div>
                                                    <div className='col-lg-2 col-md-6 col-sm-4' style={{ textAlign: "end" }}>
                                                        <button className='btn btn-sm' id='BbtnuserDetails' style={{ border: "2px solid RGBA(5,54,82,1)", marginTop: "-8px" }}><FaEdit style={{ marginTop: "-4px" }} />&nbsp;<span>{t('Edit')}</span></button>
                                                    </div>
                                                </div>
                                                {/* <div className='row' id="BuserDetails2">
                                                ...
                                                <div className='row' id="BuserDetails3" style={{ marginTop: "-5px", fontSize: "14px" }}>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Marital Status" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Marital Status</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Relation Reference Name" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Relation Reference Name</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Income Range Group" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Income Range Group</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Years Of Earning" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Years Of Earning</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Land Holding" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Land Holding</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Residence Type" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Residence Type</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                                ...
                                                                return (
                                                                    <div key={index} className="row">
                                                                        {attribute.attributetype == "Years In Residence" ?
                                                                            <div>
                                                                                <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>Years In Residence</p>
                                                                                <p style={{ color: "RGBA(5,54,82,1)", marginTop: "-15px" }}>{attribute.attributevalue}</p>
                                                                            </div >
                                                                            : null}
                                                                    </div>
                                                ...
                                                <div className='row' id='Buserdetails4' style={{ display: "none", marginTop: "-14px", fontSize: "14px" }}>
                                                    <button style={myStyle2} id="BuserdetailBtn">
                                                        <FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span>
                                                    </button>
                                                    <EditBorPersonalDetails />
                                                </div>

                                            </div>
                                            <div id="address-details" className=" register-form tab-pane fade" style={{ padding: '30px', cursor: "default", fontSize: "14px" }}>
                                                <div className="row" style={{ marginTop: "-15px" }}>
                                                    <div className='col-lg-10 col-md-6 col-sm-5' id='Baddressdetails0' style={{ fontFamily: "Poppins,sans-serif", fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                        <FaMapMarkerAlt style={{ marginTop: "-6px" }} />&nbsp;<span>{t('Address Info')}</span>
                                                        <hr style={{ marginTop: "1px" }} />
                                                    </div>
                                                    <div className='col-lg-2 col-md-6 col-sm-4' style={{ textAlign: "end" }}>
                                                        {/* <Link to="/editBorAddressDetails">
                                                ...
                                                {/* <div className="form-row" id='Baddressdetails1'>
                                            ...
                                            {this.state.address1 == "" && this.state.address2 == "" && this.state.address3 == "" && this.state.city == "" ? null :
                                                <div className='row' id='Baddressdetails2' style={{ marginTop: "-10px" }}>
                                            ...
                                            {this.state.taluk == "" && this.state.district == "" && this.state.state == "" && this.state.pincode == "" ? null :
                                                <div className='row' id='Baddressdetails3'>
                                                ...
                                                <div className="form-row" id='Baddressdetails4'>
                                                    <div className='col-4' id='headinglndwl'>
                                                        <div className="two__image" style={{ paddingLeft: "20px", marginLeft: "-10px" }}>
                                                            <p className="text-white" style={{ paddingBottom: "6px", fontWeight: "600", fontSize: "14px" }}>Permanent Address</p>
                                                        </div>
                                                    </div>
                                                    <div className='col' style={{ marginLeft: "-78px", color: "RGBA(5,54,82,1)", fontSize: "14px" }}>
                                                        ...
                                                        {/* {(this.state.permanentAddressStatus === 1 || this.state.permanentAddressStatus === 9) ? <FaCheckCircle style={{ color: "green" }} /> :
                                                        this.state.permanentAddressStatus === 0 ? <FaTimesCircle style={{ color: "grey" }} /> :
                                                            this.state.permanentAddressStatus === 2 && "Rejected"} */}
                                                    </div>
                                                </div>
                                                {this.state.paddress1 == "" && this.state.paddress2 == "" && this.state.pstate1 == "" && this.state.pcity == "" ? <span style={{ fontSize: "14px" }}>Permanent Address are empty, Please add permanent address details from edit button. </span> :
                                                    <div className='row' id='Baddressdetails5' style={{ marginTop: "-10px" }}>
                                                ...
                                                {this.state.ptaluk == "" && this.state.pdistrict == "" && this.state.landmark == "" && this.state.ppincode == "" ? null :
                                                    <div className='row' id='Baddressdetails6'>
                                                ...
                                                <div className='row' id='Baddressdetails7' style={{ display: "none", marginTop: "-4px" }}>
                                                    <button style={myStyle2} id="BaddressdetailBtn">
                                                        <FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span>
                                                    </button>
                                                    {/* <EditBorAddressDetails parentCallback={this.handleCallback} /> */}
                                                </div>

                                            </div>

                                            <div id="bank-details" className=" register-form tab-pane fade" style={{ padding: '30px', cursor: "default", fontSize: "14px" }}>
                                                <div className="row" style={{ marginTop: "-10px" }}>
                                                    <div className='col-lg-10 col-md-6 col-sm-5' id="Bbankdetails1" style={{ fontFamily: "Poppins,sans-serif", fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                        <FaHouseUser style={{ marginTop: "-6px" }} />&nbsp;<span>Bank Info
                                                            {sessionStorage.getItem('SisAccountVerified') == 0 ? <span>&nbsp;<FaTimesCircle style={{ color: "grey" }} />&nbsp;{`(Account Not Verified)`}</span> :
                                                                <span>{sessionStorage.getItem('SisAccountVerified') == 1 ?
                                                                    <span>&nbsp;<FaCheckCircle style={{ color: "green" }} /></span> :
                                                                    <span>&nbsp;<FaTimesCircle style={{ color: "grey" }} />&nbsp;{`(Account Not Verified)`}</span>}</span>}
                                                        </span>
                                                        <hr style={{ marginTop: "1px" }} />
                                                    </div>
                                                    <div className='col-lg-2 col-md-6 col-sm-4' style={{ textAlign: "end" }}>
                                                        {/* <Link to="/editBorBankDetails">
                                                        <button className='btn btn-sm' style={{ border: "2px solid RGBA(5,54,82,1)", marginTop: "-8px" }}><FaEdit style={{ marginTop: "-4px" }} />&nbsp;<span>Edit</span></button>
                                                    </Link> */}
                                                        <button className='btn btn-sm' id="BbtnBankdetails" style={{ border: "2px solid RGBA(5,54,82,1)", marginTop: "-8px" }}><FaEdit style={{ marginTop: "-4px" }} />&nbsp;<span>Edit</span></button>
                                                    </div>
                                                </div>
                                                {/* <div className='row' id="Bbankdetails0">
                                                <div className='float-left'>
                                                    {sessionStorage.getItem('SisAccountVerified') == 0 ? <p><FaTimesCircle style={{ color: "grey" }} />&nbsp;Account Not Verified</p> :
                                                        <span>{sessionStorage.getItem('SisAccountVerified') == 1 ?
                                                ...
                                                <div className='row' id="Bbankdetails2">
                                                ...
                                                <div className='row' id="Bbankdetails3">
                                                    <div className='col-sm-6 col-md-6 col-lg-3'>
                                                ...
                                                <div className='row' id='Bbankdetails4' style={{ display: "none", marginTop: "-14px" }}>
                                                    <button style={myStyle2} id="BbankdetailBtn">
                                                        <FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span>
                                                    </button>
                                                    <EditBorBankDetails parentCallback={this.handleCallback2} />
                                                </div>

                                            </div>
                                            <div id="kyc-documents" className=" register-form tab-pane fade" style={{ padding: '30px', cursor: "default", fontSize: "14px" }}>
                                                {/* <div className="float-right">
                                                <h5>✏️Edit</h5>
                                            </div> */}
                                                {/* <form> */}
                                                ...
                                                <div className="form-group">
                                                    {sessionStorage.getItem('SisVkycVerified') == 0 ? <div className='pt-2'>
                                                        ...
                                                        <input type="number" className="input" name="mobile_no" id="mobile_no" placeholder="Enter Mobile Number" style={{ display: "none" }} value={sessionStorage.getItem("B_mobile")} />
                                                        ...
                                                        {/* <div className="row">
                                                        <div style={{ marginTop: "-72px", marginLeft: "230px" }}>
                                                            <button type="button" className="btn btn-success pl-3 pr-3 pb-2 ml-3 mt-4 mb-2" onClick={this.getKYC}>Initiate VKYC request *</button>
                                                        </div>
                                                        <div className='' style={{ marginLeft: "15px" }}>
                                                            <p className="text-primary">*Once verification is done, please check the status after re-login.</p>
                                                        </div>

                                                        <form className="form pt-3" style={{ display: "none" }} action="/action_page.php">
                                                            <label>Document Number
                                                                <input type="text" onChange={this.documentNumber} className="form-control" placeholder={this.state.pdocsNum} />
                                                            </label>
                                            ...
                                            <div id="ovd-documents" className=" register-form tab-pane fade" style={{ padding: '20px', cursor: "default", fontSize: "14px" }}>
                                                <div className="form-group">
                                                    <div>
                                                        <div className='row' style={{ marginTop: "-15px" }}>
                                                            <div className='col-lg-10 col-md-6 col-sm-4' style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                                                                                ...
                                                                                                                <div className='card border-0' style={{ transition: 'none', overflow: "visible", color: "rgb(5, 54, 82)", cursor: 'default', marginLeft: "1px", backgroundColor: (index % 2 == 0) ? 'rgba(255,255,255,1)' : 'rgba(242,242,242,1)' }}>
                                                                                                                    <div className="row item-list align-items-center">
                                                                                                                        <div className="col-2" style={{ paddingLeft: "20px" }}>
                                                                                                                            <p className="p-0" style={{ fontSize: "14px", fontWeight: "490", marginTop: "15px", marginLeft: "10px" }}>{Lists.ovdcode}</p>
                                                                                                                        </div >
                                                                                                                        <div className="col-2">
                                                                                                                            <p style={{ fontSize: "14px", fontWeight: "490", paddingTop: "12px" }}>{Lists.mobileno}</p>
                                                                                                                        </div >
                                                                                                                        <div className="col-2">
                                                                                                                            <p style={{ fontSize: "14px", fontWeight: "490", paddingTop: "12px", marginLeft: "-5px" }}>{Lists.createdon && Lists.createdon.split("-").reverse().join("-")}</p>
                                                                                                                        </div>
                                                                                                                        <div className="col-2">
                                                                                                                            <p className="" style={{ fontSize: "14px", fontWeight: "490", paddingTop: "12px" }}>{Lists.status == 0 ? "Not Verified" : <span>{Lists.status == 1 ? "Approved" : <span>{Lists.status == 2 ? "Rejected" : ""}</span>}</span>}</p>
                                                                                                                        </div>
                                                                                                                        <div className="col-2">
                                                                                                                            <p className="" style={{ fontSize: "14px", fontWeight: "490", paddingTop: "12px" }}>{Lists.reviewedby ? Lists.reviewedby : "-"}</p>
                                                                                                                        </div>
                                                                                                                        <div className="col-1" style={{ textAlign: "" }}>
                                                                                                                            <p className="" style={{ fontSize: "14px", fontWeight: "490", paddingTop: "12px", marginLeft: "-25px" }}>{Lists.rejectreason ? Lists.rejectreason : "-"}&nbsp;
                                                                                        ...
                                                                                        return (
                                                                                            <div className='col-lg-3 col-md-6 col-sm-12 mb-2' key={index}>
                                                                                                <button type="button" className="btn"
                                                                                                    ...
                                                                                                    <FaEye style={{ marginTop: "-4px" }} />&nbsp;{list.docname}
                                            ...
                                            <div id="set-pin" className=" register-form tab-pane fade" style={{ padding: '20px', cursor: "default", fontSize: "14px" }}>
                                                <>
                                                    {MPINFlag == "1" ?
                                                        <>
                                                            <div className='row' id='pinmgmtField' style={{ marginTop: "-15px" }}>
                                                                <div className='col'>
                                                        ...
                                                        <>{MPINFlag == "2" ?
                                                            <>
                                                                ...
                                                                <div id='setMpinBtn' className='row'>
                                                                    ...
                                                                    <div className='col-4'>
                                                                        <p style={{ fontWeight: "bold", color: "RGBA(5,54,82,1)", fontSize: "14px" }}>Set Transaction PIN &nbsp;<BsIcons.BsFillCaretDownSquareFill onClick={this.enableSetMpin} style={{ cursor: "pointer" }} /></p>
                                                                        {/* <button className='btn btn-sm text-white' style={{ backgroundColor: "#0079bf" }} >Set Transaction PIN</button> */}
                                                                    </div>
                                                                </div>
                                                                <div id='viewSetMpinFields' style={{ display: "none" }}>
                    ...
                    <div class="modal fade" data-backdrop="static" id="exampleModalCenter29" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content" id='uploadOvdDocFirst'>
                                <div class="modal-body" style={{ cursor: "default", fontSize: "14px" }}>
                                    <div className='row'>
                                        <div className='col'>
                                        ...
                                        <div className="col">
                                            ...
                                            <select className='form-select' style={{ marginTop: "-10px" }} onChange={this.selectOvdDocument}>
                                                ...
                                                {this.state.ovdMasterList.map((list, index) => {
                                                    const isDisabled = existingOVDCodes.includes(list.ovdcode);
                                                    return (
                                                        <option key={index} value={list.ovdcode} style={isDisabled ? { color: "grey" } : {}}>
                                                            {list.ovddesc}{isDisabled && `(Uploaded)`}
                                                        </option>
                                                    )
                                                })}
                    ...
                    {/* T&C Policy */}
                    <button id='borDeclaration' type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg12" style={{ display: "none" }}>
                        Launch demo modal
                    </button>
                    <div className="modal fade bd-example-modal-lg12" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div className="modal-dialog modal-lg" role="document">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <iframe src="" className="PDFdocBor" type="text/plain" style={{ overflow: "auto", height: "85vh", width: "100%" }}>
                                    </iframe>
                                </div>
...
export default withTranslation()(BorrowerDetails)
...
export class RepaySchedule extends Component {
    //updated
    constructor(props) {
        super(props)
                    ...
                    <div className="container-fluid row pt-2">
                        ...
                        <div className='col-7' id='evanavRes2' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / <Link to="/ViewAllLoans">View All Loans</Link> / Repayment Schedule</p>
                        </div>
                        <div className='col'>
                        ...
                        <div className="col" id='evanavRes3'>
                            <button style={myStyle}>
                                <Link to="/ViewAllLoans"><FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span></Link></button>
                        </div>
                    </div>
                                                ...
                                                <Tbody>
                                                    {this.state.EmiSchedule.map((loan, index) => (
                                                        <Tr key={index} style={{
                                                            ...
                                                            <Td style={{ fontSize: "14px", fontWeight: "490", textAlign: "right" }}>{loan.emidate.split("-").reverse().join("-")}</Td>
                                                        </Tr>
                                                    ))}
                                                </Tbody>
                                            </Table>
...
export default withTranslation()(RepaySchedule)

...
import './BorAccStatement.css'
import { confirmAlert } from "react-confirm-alert";
import { Table, Thead, Tbody, Tr, Th, Td } from 'react-super-responsive-table';
import 'react-super-responsive-table/dist/SuperResponsiveTableStyle.css';

class BorAccStatement extends Component {
    constructor(props) {
        super(props)
                    ...
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-6' id="borAccRes2" style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / <Link to="/ViewAllLoans">View All Loans</Link> / Account Statement</p>
                        </div>
                        <div className='col'>
...
export default withTranslation()(BorAccStatement)

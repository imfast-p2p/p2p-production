...
class PaymentQRCodeDue extends Component {
    //updated
    constructor(props) {
        super(props)
                ...
                <div className="main-content" id="page-content-wrapper">
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-7' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / <Link to="/payDues">Payment Gateway</Link> / Payment With QR Code</p>
                        </div>
                        <div className='col'>
                        ...
                        <div className="col">
                            <button style={myStyle}>
                                <Link to="/payDues" style={{ marginLeft: "10px" }}><FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span></Link></button>
                        </div>
                    </div>
                    ...
                    <div className='row text-center' style={{ marginRight: "100px" }}>
                        <div >
                            {
                                sessionStorage.getItem('userType') == 3 ?
                                    <p style={{ fontFamily: "Poppins,sans-serif", fontSize: "15px", color: "#222C70", fontWeight: "bold" }}>Borrower Due</p> : <div></div>
                            }
                        </div>
                        <div >
...
export default PaymentQRCodeDue

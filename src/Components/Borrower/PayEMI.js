...
export class PayEMI extends Component {
    //updated
    constructor(props) {
        super(props)
            ...
            <div className="container-dashboard d-flex flex-row" id="wrapper" style={{ marginTop: "-7px", backgroundColor: "#f4f7fc" }}>
                ...
                <div className="main-content" id="page-content-wrapper">
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-5' id='LPay2' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/borrowerdashboard">Home</Link> / <Link to="/loanClosureBalance">Loan Closure Balance</Link> / Payment Gateway</p>
                        </div>
                        <div className='col'>
                        ...
                        <div className="col" id='LPay3'>
                            <button style={myStyle}>
                                <Link to="/loanClosureBalance" style={{ marginLeft: "10px" }}><FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span></Link></button>
                        </div>
                    </div>
                    ...
                    <form action="https://test.payu.in/_payment" target="_blank" name="payuform" method="POST">
                        ...
                        {/* <div className="row" style={{ marginTop: "-90px" }}>
                            <div className="card border-0 register-form tab-pane fade show active " id="user-details" style={{ padding: '30px', marginLeft: '45px', width: '92%' }}>
                                <div className="row">
                                    <label className="pl-3" style={{ textAlign: 'center' }}>{t('Loan Account Number: ')}
                                        <span style={{ fontWeight: "lighter" }}>{sessionStorage.getItem('loanaccountno')}</span>
                                    </label>
                                    <label className="pl-3" style={{ textAlign: 'center' }}>{t('Amount: ')}
                                        <span style={{ fontWeight: "lighter" }}>₹{parseFloat(sessionStorage.getItem('amount')).toFixed(2).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}</span>
                                    </label>
                                </div>
                                <hr />
                                ...
                                <div className="row">
                                    ...
                                    <label for="chkNo" className='col' style={{ marginLeft: "140px" }}>
                                        <input type="radio" id="chkNo" name="chkQstn" />
                                        {t('PaywithQRCode')}
                                    </label>
                                    <label for="chkUYes" className='col' style={{ marginLeft: "140px" }}>
                            ...
                            <div className='' style={{ marginLeft: "15%" }}>
                                <div className="card" style={{ cursor: 'default', width: "50%" }}>
                                    ...
                                    <div className='form-group pl-2 pr-2' style={{ marginTop: "-20px" }}>
                                        <div className='row'>
                                            <div className='col'>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>{t('Loan Account Number')}</p>
                                            </div>
                                            <div className='col' style={{ textAlign: "end" }}>
                                                <p style={{ color: "rgb(31, 88, 126)" }}><span style={{ fontWeight: "bold" }}>{sessionStorage.getItem('loanaccountno')}</span>
                                                </p>
                                            </div>
                                        </div>
                                        <div className='row'>
                                            <div className='col'>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>{t('Amount')}</p>
                                            </div>
                                            <div className='col' style={{ textAlign: "end" }}>
                                                <p style={{ color: "rgb(31, 88, 126)" }}><span style={{ fontWeight: "bold" }}>₹ {parseFloat(sessionStorage.getItem('amount')).toFixed(2).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}</span>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div className='form-group pl-2 pr-2' id="qrcode" style={{ display: "none", marginTop: "-20px" }}>
                                        <div className='row'>
                                            <div className='col-6' style={{ textAlign: "end", paddingRight: "1px" }}>
                                                <Link to="/paymentQRCodeEmi">
                                                    <button className="btn text-white" style={{ backgroundColor: "rgb(136, 189, 72)" }}>Pay With QR Code</button>
                                                    {/* <button className="btn btn-success">Pay With QR Code</button> */}
                                                </Link>
                                            </div>
                                            <div className='col-4'>
                                                <Link to="/borrowerdashboard">
                                                    <button className="btn text-white ml-2" style={{ backgroundColor: "#0079bf" }}>Cancel</button>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
...
export default withTranslation()(PayEMI)

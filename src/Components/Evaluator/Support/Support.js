...
var paymentRelFlag;
export class EvlSupport extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loginname: "",
                    ...
                    <div className="container-fluid row pt-2">
                        ...
                        <div className='col-4' id="" style={{ marginLeft: "40px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/evaluatorDashboard">Home</Link> / Support</p>
                        </div>
                        <div className='col'>
                    ...
                    <div class="container" style={{ width: "94%" }}>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <ul class="nav nav-pills flex-column" id="myTab" role="tablist" style={{ fontSize: "16px", fontFamily: "Poppins,sans-serif" }}
                                >
                            ...
                            <div class="col-md-8">
                                <div class="tab-content" id="myTabContent" style={{ marginTop: "-15px", marginLeft: "-20px" }}>
                                    ...
                                    <div class="tab-pane fade show active" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                                        <div className="card" style={{ cursor: "default", overflow:"auto" }}>
                                            <div className="card-header border-1 bg-white">
                                                <div className='row'>
                                                    <div className='col'>
                                                        <p style={{ color: "rgba(5,54,82,1)", fontSize: "16px" }}><FaIcons.FaTicketAlt /><span className="font-weight-bold">&nbsp;Raise Ticket</span></p>
                                                    </div>
                                                </div>
                                                <hr className='col-11' style={{ marginTop: "-15px" }} />
                                                <div className='row mb-2' >
                                                    <div className='col-6'>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>Issue Type *</p>
                                                        <select id="inputState" style={{ backgroundColor: "rgb(247, 248, 250)", marginTop: "-12px", fontSize: "14px" }}
                                                    ...
                                                    <div className='col-6 paymentRelatedTag' style={{ display: "none" }}>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Bank Ref. No. *')}</p>
                                                        <input className='form-control' type='text' placeholder='Enter Reference no.' style={{ marginTop: "-12px", fontSize: "14px" }} onChange={this.bankRef} />
                                                ...
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    <div className='col-6'>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Payment Mode')}</p>
                                                        <select className='form-select' onChange={this.paymentMode} style={{ marginTop: "-12px", fontSize: "14px" }}>
                                                    ...
                                                    <div className='col-6'>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Payment Date *')}</p>
                                                        <input className='form-control' type='date' style={{ marginTop: "-12px", fontSize: "14px" }} onChange={this.paymentDate} />
                                                        {this.state.isPaymentDateValid === false ? <p className='text-danger'>Future date can not be selected as payment date</p> : ""}
                                                    </div>
                                                </div>
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    <div className='col-6'>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Payment Purpose *')}</p>
                                                        <select className='form-select' onChange={this.paymentPurp} style={{ marginTop: "-12px", fontSize: "14px" }}>
                                                            <option defaultValue>Select Payment Purpose</option>
                                                            <option value="5">Evaluator top up</option>
                                                        </select>
                                                    </div>
                                                    <div className="form-group col-md-6">
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Amount *')}</p>
                                                        <input className='form-control' type='text' placeholder='Enter Amount' style={{ marginTop: "-12px", fontSize: "14px" }} onChange={this.Amount} />
                                                ...
                                                <div className="row mb-2">
                                                    <div className='col-6 paymentRelatedTag' style={{ display: "none" }}>
                                                        <p htmlFor="Name" style={{ color: "#222C70", fontFamily: "Poppins,sans-serif", fontWeight: "bold", fontSize: "14px" }}>{t('Payment To Account(Optional)')}</p>
                                                        <input className='form-control' type='text' placeholder='Enter Account number' style={{ marginTop: "-12px", fontSize: "14px" }} onChange={this.accNo} />
                                                        {this.state.isAccountNoValid === false ? <p className='text-danger'>Please enter a valid account number.</p> : ""}
                                                    </div>
                                                    <div className={(paymentRelFlag?.includes("PY") ? 'col-6' : 'col')} style={{ fontSize: "14px" }}>
                                    ...
                                    <div class="tab-pane fade" id="view-ticket" role="tabpanel" aria-labelledby="viewTicket-tab">
                                        <div className="card" style={{ cursor: "default", overflow:"auto" }}>
                                            <div className="card-header border-1 bg-white">
                                                <div className='row'>
                                                    <div className='col'>
                                                        <p style={{ color: "rgba(5,54,82,1)", fontSize: "15px" }}><FaIcons.FaTicketAlt /><span className="font-weight-bold">&nbsp;View Tickets</span></p>
                                                    </div>
                                                </div>
                                                <hr className='col-12' style={{ marginTop: "-10px", width: "95%" }} />
                                                <div className='row mb-2'>
                                                    <div className='col-lg-3 col-md-6 col-sm-12 mb-3' id='date1' style={{ fontSize: "14px" }}>
                                                    ...
                                                    <div className='col-lg-3 col-md-6 col-sm-12 mb-3' id='date2' style={{ fontSize: "14px" }}>
                                                        <p htmlFor="date" style={{
                                                            fontFamily: "Poppins, sans-serif",
                                                            marginLeft: "0px",
                                                            color: "rgba(5,54,82,1)",
                                                    ...
                                                    <div className='col-lg-3 col-md-6 col-sm-12 mb-3' style={{ fontSize: "14px" }}>
                                                        <p htmlFor="date" style={{
                                                            fontFamily: "Poppins, sans-serif",
                                                            marginLeft: "0px",
                                                            color: "rgba(5,54,82,1)",
                                                    ...
                                                    <div className='col-lg-3 col-md-6 col-sm-12 mb-3' style={{ fontSize: "14px" }}>
                                                        <button className='btn text-white' onClick={this.getsupportTickets} disabled={this.state.dateError}
                                                            style={{
                                    ...
                                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                        <div className="card" style={{ cursor: "default" }}>
                                            <div className="card-header border-1 bg-white">
                                                ...
                                                <div class="row" style={{ color: "rgb(5, 54, 82)", fontSize: "14px" }}>
                                                    <div class="col-3">
                                                ...
                                                <div class="col-12">
                                                            ...
                                                            <div>
                                                                <button class="btn btn-light border btn-lg px-3">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal feather-lg">
                                                                        <circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1">
                                                                        </circle><circle cx="5" cy="12" r="1"></circle></svg></button>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="position-relative scrollbar" style={{ height: "50vh" }}>
                                                        <div class="chat-messages p-4">
                                                            <div class="chat-message-left pb-4">
                                                                <div class="flex-shrink-1 rounded py-2 px-3 ml-3" style={{ backgroundColor: "rgb(230, 243, 245)" }}>
                                                                    Hi, Welcome to Integra Money Lending Platform.
                                                                </div>
                                                                <div>
                                                                    <div class="text-muted small text-nowrap mt-2">2:34 pm</div>
                                                                </div>
                                                            </div>

                                                            <div class="chat-message-left pb-4">
                                                                <div class="flex-shrink-1 rounded py-2 px-3 ml-3" style={{ backgroundColor: "rgb(230, 243, 245)" }}>
                                                                    Please help us with the service you're looking for
                                                                </div>
                                                                <div>
                                                                    <div class="text-muted small text-nowrap mt-2">2:34 pm</div>
                                                                </div>
                                                    ...
                                                    <div class="flex-grow-0 py-3 px-4 border-top">
                                                        <div class="input-group">
                                                            ...
                                                            <button class="btn text-white" style={{ backgroundColor: "#0074bf" }}>Send</button>
                                                        </div>
                                                    </div>
...
export default withTranslation()(EvlSupport)
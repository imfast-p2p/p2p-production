...
//updated
export class EditEvaBankDetails extends Component {
    ...
    accountno2 = (event) => {
        switch (event.target.name) {
            case "confirm-account": (event.target.value !== document.getElementsByName('account')[0].value) ?
                ...
                $('#evlbankSubmitBtn').prop('disabled', true)
                break;
    ...
    branch(event) {
        ...
        if (branchInput.test(eventInput)) {
            ...
            $('#evlbankSubmitBtn').prop('disabled', false)
        ...
        if (match.test(accountifsc)) {
            fetch(BASEURL + '/usrmgmt/setaccountdetails', {
                ...
                body: JSON.stringify({
                    ...
                    accountno: parseInt(this.state.accountno),
            ...
            <div>
                ...
                <div className="row">
                    ...
                    <div className='col-3' style={{ textAlign: "end" }}>
                        <button className='btn btn-sm text-white' id='evlbankSubmitBtn' style={{ backgroundColor: "rgb(136, 189, 72)", marginTop: "-8px" }}
...
export default EditEvaBankDetails
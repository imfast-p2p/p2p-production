...
var globalStateList;
export class EditLndAddressDetails extends Component {
        ...
        fetch(BASEURL + '/usrmgmt/getaddressdetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    // console.log(resdata.msgdata[0]);
                    // this.setState({ address1: resdata.msgdata[0].address1 })
                    // this.setState({ address2: resdata.msgdata[0].address2 })
                    // this.setState({ address3: resdata.msgdata[0].address3 })
                    // this.setState({ city: resdata.msgdata[0].city })
                    // this.setState({ state1: resdata.msgdata[0].state })
                    // this.setState({ pincode: resdata.msgdata[0].pincode })
                    // this.setState({ district: resdata.msgdata[0].district })
            ...
            <div>
                ...
                <div className='row'>
                    <div className='col-sm-2 col-md-3 col-lg-3'>
                        ...
                        <select id="inputState" className="form-control" style={{ marginTop: "-5px", color: "RGBA(5,54,82,1)" }} onClick={this.state1}>
                    ...
                    <div className='col-sm-2 col-md-3 col-lg-3'>
                        ...
                        <select id="inputDistrict" className="form-control" style={{ width: '89%', marginTop: "-5px", color: "RGBA(5,54,82,1)" }} onChange={this.district}>
...
export default EditLndAddressDetails
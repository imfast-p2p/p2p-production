...
import '../../Borrower/Support/Support.css';
...
var paymentRelFlag;
export class LndSupport extends Component {
    ...
    raiseSupportTicket = () => {
        ...
        if (paymentRelFlag.includes("PY")) {
            value = JSON.stringify({
                ...
                mobilenumber: this.state.Lmobile,
                    ...
                    <div className="container-fluid row pt-2">
                        ...
                        <div className='col-5' id="" style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/lenderdashboard">Home</Link> / Support</p>
                        </div>
                        <div className='col'>
                                            ...
                                            <div className="card-header border-1 bg-white">
                                                ...
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    ...
                                                    <div className='col-6'>
                                                        ...
                                                        <input className='form-control' type='date' onChange={this.paymentDate} style={{ marginTop: "-12px" }} />
                                                ...
                                                <div className='row mb-2 paymentRelatedTag' style={{ display: "none" }}>
                                                    <div className='col-6'>
                                                        ...
                                                        <select className='form-select' onChange={this.paymentPurp} style={{ marginTop: "-12px" }}>
                                                            ...
                                                            <option value="3">Lender top up</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div className="row mb-2">
                                                    ...
                                                    <div className={paymentRelFlag == "PY002" ? 'col-6' : 'col'}>
...
export default withTranslation()(LndSupport)
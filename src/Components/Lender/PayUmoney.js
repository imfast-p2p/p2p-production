...
export class PayUmoney extends Component {
    //updated
    constructor(props) {
        super(props)
                    ...
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-5' id='LPay2' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/lenderdashboard">Home</Link> / <Link to="/myWallet">Escrow Account</Link> / Payment Gateway</p>
                        </div>
                        <div className='col'>
                            ...
                            <div className='' style={{ marginLeft: "15%" }}>
                                <div className="card" style={{ cursor: 'default', width: "50%" }}>
                                    ...
                                    <div className='form-group pl-2 pr-2' style={{ marginTop: "-20px" }}>
                                        <div className='row'>
                                            <div className='col'>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>{t('Lender Topup ')}</p>
                                            </div>
                                    ...
                                    {/* Route to myWallet*/}
                                    <Link to="/myWallet"><button id='payuMoney' style={{ display: "none" }}>Refresh
                                    </button></Link>
                                </div>
                            </div>
                        </div>
...
export default withTranslation()(PayUmoney)

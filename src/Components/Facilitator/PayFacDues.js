...
export class PayFacDues extends Component {
    //updated
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        if (this.state.paymenttype == 2) {
            ...
            $("#borLoanReqNO").hide();
            this.setState({ memmID: sessionStorage.getItem("userMemmid") })
            console.log(this.state.memmID)
        }
    ...
    submitUpiForm() {
        ...
        if (this.state.paymenttype == 2) {
            var submitUPI = borrData
        } else if (this.state.paymenttype == 4) {
            var submitUPI = facData
        } else if (this.state.paymenttype == 3) {
            var submitUPI = borrDue
        }
        console.log(submitUPI)
        //var submitUPI = this.state.paymenttype ? borrData : facData
                    ...
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-5' id='LPay2' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/facilitatorDashboard">Home</Link> / Payment Gateway</p>
                        </div>
                        <div className='col'>
                            ...
                            <div className='' style={{ marginLeft: "15%" }}>
                                <div className="card" style={{ cursor: 'default', width: "50%" }}>
                                    ...
                                    <div className='form-group pl-2 pr-2' style={{ marginTop: "-20px" }}>
                                        <div className='row' id="borLoanReqNO">
                                            <div className='col'>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>Loan Request number</p>
                                            </div>
                                            <div className='col' style={{ textAlign: "end" }}>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>{this.state.LoanReqno}</p>
                                            </div>
                                        </div>
                                        <div className='row'>
                                            <div className='col'>
                                                <p style={{ color: "rgb(31, 88, 126)" }}>{this.state.heading}</p>
                                            </div>
                                            <div className='col' style={{ textAlign: "end" }}>
                                    ...
                                    {/* Route to dashboard*/}
                                    <Link to="/facilitatorDashboard"><button id='facDashboard' style={{ display: "none" }}>Refresh
                                    </button></Link>
...
export default withTranslation()(PayFacDues)

...
import './facRefDetails.css';
import { confirmAlert } from "react-confirm-alert";

//updated
export class FacReferenceDetails extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            checkFacMnum: sessionStorage.getItem("F_Mobile"),
            numError: false,
        }
                    ...
                    <div className="container-fluid row pt-2">
                        ...
                        <div className='col-4' id='facnavRes2' style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/facilitatorDashboard">Home</Link> / Reference Details</p>
                        </div>
                        <div className='col'>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                >
                                    ...
                                    <li class="nav-item" onClick={this.getRefDetails}>
                                        <a class="nav-link" id="refprofile-tab" data-toggle="tab"
                                            href="#profile" role="tab" aria-controls="profile" aria-selected="false"><FaUsers />&nbsp;View Reference Details</a>
                                    </li>
                                </ul>
                            </div>
                                                ...
                                                <div className="form-row">
                                                    <div className='col-6'>
                                                        <p className="font-weight-bold" style={{ fontWeight: "500", marginBottom: "1px", color: "#222C70", fontSize: "15px" }}>
                                                            Associate: <span style={{ fontWeight: "400" }}>{`${sessionStorage.getItem("facName")}` + `(${sessionStorage.getItem("userID")})`}</span>
                                                        </p>
                                                    </div>
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="h-100 p-5">
                            <ul role="tablist" className="nav bg-light nav-pills nav-fill mb-3">
                                ...
                                <li className="nav-item"> <a data-toggle="pill" href="#viewRef-details" className="nav-link border"> {t('ViewReferenceDetails')} </a> </li>
                            </ul>
                        </div>
...
export default withTranslation()(FacReferenceDetails)

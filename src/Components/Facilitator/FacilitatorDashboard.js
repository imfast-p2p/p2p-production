...
import { BASEURL, CP_VERSION } from '../assets/baseURL';
import $ from 'jquery';
...
class FacilitatorDashboard extends Component {
        ...
        fetch(BASEURL + '/usrmgmt/getpersonaldetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    //console.log(resdata);
                    sessionStorage.setItem('facName', resdata.msgdata.name)
    ...
    facilitatorSummary() {
        ...
        fetch(urlDash, {
            ...
            .then((resdata) => {
                if (resdata.status == 'SUCCESS') {
                    console.log(resdata);
                    this.setState({ facSummary: resdata.msgdata });
                    ...
                    this.setState({ totloansfacilitated: resdata.msgdata.totloansfacilitated });
                    this.setState({ facilitatedloanreqamt: resdata.msgdata.facilitatedloanreqamt });
                    // this.setState({ totloanamtfacilitated: resdata.msgdata.totloanamtfacilitated });
                    this.setState({ commissiondue: resdata.msgdata.commissiondue });
                    this.setState({ facilitatedloanreqs: resdata.msgdata.facilitatedloanreqs });
    ...
    addMoney() {
        ...
        //     var paymenttype = 4; //2 for Borrower repayment,4 for Facilitator Topup
                        ...
                        <div className='col'>
                            <div className="card shadow-sm p-3 mb-3" id='commonCard-container'>
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-4">
                                        <p className='facAccStatus' style={{ fontFamily: "Poppins,sans-serif", paddingLeft: "20px", fontWeight: "bold", fontSize: "15px", textAlign: "center", color: "#222C70", display: "none" }}>Your profile is {resultant}% complete</p>
                                        <div className='row mb-2 facAccStatus' style={{ marginTop: "-10px", display: "none" }}>
                                        ...
                                        <div className='col'>
                                            ...
                                            <div className='row p-2'>
                                                <div className='col' style={{ color: "rgba(5,54,82,1)", fontSize: "14px" }}>
                                                    <p>1.After registration add reference details.</p>
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col">
                                        <div className="card-content" style={{ color: "rgba(255,255,255,1)" }}>
                                            <p className="greeting m-0">{t('Facilitated Requests')}</p>
                                            <p className="subtext m-0">
                                                {this.state.facilitatedloanreqs ? this.state.facilitatedloanreqs : "0"}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3" >
                            <div className="card shadow-sm p-3 mb-3" style={{ borderRadius: "16px", color: "rgba(255,255,255,1)", backgroundColor: "RGBA(254,192,48,1)", cursor: "default" }}>
                                <div className="row align-items-center">
                                    ...
                                    <div className="col">
                                        <div className="card-content" style={{ color: "rgba(255,255,255,1)" }}>
                                            <p className="greeting m-0">{t('Facilitated Amount')}</p>
                                            <p className="subtext m-0">
                                                {this.state.facilitatedloanreqamt ? <span>
                                                    ₹ {parseFloat(this.state.facilitatedloanreqamt).toFixed(2).replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ",")}
                                                </span> : "0.00"}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="card shadow-sm p-3 mb-3" style={{ fontSize: "15px", cursor: "default", borderRadius: "15px", backgroundColor: "RGBA(255,247,229,1)" }}>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-3' style={{ textAlign: "initial" }}>
                                        {this.state.facSummary.p2pdue > 0 ?
                                        ...
                                        <div className='row'>
                                            <div className='col' style={{ textAlign: "center" }}>
                                                <button className='btn text-white' id='BorcompleteProfile' data-dismiss="modal"
                                                    onClick={this.routeToProfile} style={{ backgroundColor: "rgb(0, 121, 191)" }}>
                                                    Complete Profile
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div className="row mb-5">
                            <div className="col-sm-4 col-md-4 col-lg-4 ">
                                <div className="card-header border-0 ">
                                    <Link to="/facDetails">
                                        <div className="row">
                                            <img src={profile} className="img-fluid" alt="image" style={{ width: '100%', height: '30%' }} />
                                        </div>
                                        <div className="row bg-white" style={{ width: '104%' }}>
                                            <h5>{t('Profile')}</h5>
                                        </div>
                                    </Link>
                                </div>
                            ...
                            <div className="col-sm-4 col-md-4 col-lg-4">
                                <div className="card-header border-0 ">
                                    <Link to="/borrowerProfileVerification">
                                        <div className="row">
                                            <img src={Verification} className="img-fluid" alt="image" style={{ width: '100%', height: '50%' }} />
                                        </div>
                                        <div className="row bg-white" style={{ width: '104%' }}>
                            ...
                            <div className="col-sm-4 col-md-4 col-lg-4">
                                <div className="card-header border-0 ">
                                    <Link to="/facWallet">
                                        <div className="row">
                                            <img src={wallet} className="img-fluid" alt="image" style={{ width: '100%', height: '50%' }} />
                                        </div>
                                        <div className="row bg-white" style={{ width: '104%' }}>
                                            <h5>{t('Escrow Account')}</h5>
                                        </div>
                                    </Link>
                                </div>
                            </div>
...
export default withTranslation()(FacilitatorDashboard)

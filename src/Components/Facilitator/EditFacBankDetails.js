...
//updated
export class EditFacBankDetails extends Component {
    constructor(props) {
        super(props)
        this.state = {
            accounttype: "",
    ...
    accountno2 = (event) => {
        switch (event.target.name) {
            case "confirm-account": (event.target.value !== document.getElementsByName('account')[0].value) ?
                ...
                // $('#facbankSubmitBtn').prop('disabled', true)
                break;
    ...
    branch(event) {
        ...
        if (branchInput.test(eventInput)) {
            ...
            // $('#facbankSubmitBtn').prop('disabled', false)
            ...
            <div>
                ...
                <div className="row">
                    ...
                    <div className='col-3' style={{ textAlign: "end" }}>
                        <button className='btn btn-sm text-white' id='facbankSubmitBtn' style={{ backgroundColor: "rgb(136, 189, 72)", marginTop: "-8px" }}
...
export default EditFacBankDetails
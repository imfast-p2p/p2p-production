...
import $ from 'jquery';
import FacilitatorSidebar from '../../SidebarFiles/FacilitatorSidebar';//updated
import { DIGIURL } from '../assets/baseURL';
import { confirmAlert } from "react-confirm-alert";
import { withTranslation } from 'react-i18next';
import {
    FaCheckCircle, FaAngleLeft, FaEdit, FaTimesCircle, FaFileSignature,
    FaFolderPlus, FaFileDownload, FaMapMarkerAlt, FaHouseUser, FaUserEdit, FaRegFileVideo,
    FaUserLock, FaRegSave, FaRegTrashAlt, FaFileUpload, FaEye
} from "react-icons/fa";
import dashboardIcon from '../assets/icon_dashboard.png';
import profile2 from '../assets/img1.png';
// import EditFacAddressDetails from './EditFacAddressDetails';
import EditFacBankDetails from './EditFacBankDetails';
...
export class FacDetails extends Component {
    constructor() {
        super();
        this.state = {
        ...
        fetch(BASEURL + '/usrmgmt/getpersonaldetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    sessionStorage.setItem("F_Mobile", this.state.pmobile);
                }
                else {
                    this.setState({ showLoader: false })
        ...
        fetch(BASEURL + '/usrmgmt/getaccountdetails', {
            ...
            .then((resdata) => {
                if (resdata.status === 'Success') {
                    ...
                    sessionStorage.setItem('facLaccno', resdata.msgdata.accountno)
    ...
    componentDidMount() {
        ...
        this.onSelectOption();
        console.log(sessionStorage.getItem("F_Mobile"));
        ...
        $("#FbtnAddressdetails").click(function () {
            $("#Faddressdetails0").hide();
            $("#Faddressdetails1").hide();
            $("#Faddressdetails2").hide();
            $("#Faddressdetails3").hide();
            $("#Faddressdetails4").hide();
            $("#Faddressdetails5").hide();
            $("#Faddressdetails6").hide();
            $("#FbtnAddressdetails").hide();
            $("#msg").hide();

            $("#Faddressdetails7").show();
        })
        $("#BaddressdetailBtn").click(function () {
            $("#Faddressdetails0").show();
            $("#Faddressdetails1").show();
            $("#Faddressdetails2").show();
            $("#Faddressdetails3").show();
            $("#Faddressdetails4").show();
            $("#Faddressdetails5").show();
            $("#Faddressdetails6").show();
            $("#FbtnAddressdetails").show();

            $("#Faddressdetails7").hide();
        })

        $("#FbtnBankdetails").click(function () {
            $("#Fbankdetails0").hide();
            $("#Fbankdetails1").hide();
            $("#Fbankdetails2").hide();
            $("#Fbankdetails3").hide();
            $("#FbtnBankdetails").hide();

            $("#Fbankdetails4").show();

        })
        $("#FbankdetailBtn").click(function () {
            $("#Fbankdetails0").show();
            $("#Fbankdetails1").show();
            $("#Fbankdetails2").show();
            $("#Fbankdetails3").show();
            $("#FbtnBankdetails").show();
    ...
    handleSelectChange = (e, element, index) => {
        ...
        // var poaExtData2 = poaData.map((item, i) => ({
        //     field: item.field,
        //     value: item.value || ""
                    ...
                    <div className="container-fluid row pt-2" style={{ marginBottom: "-11px" }}>
                        ...
                        <div className='col-4' id="BnavRes2" style={{ marginLeft: "20px", marginTop: "5px" }}>
                            <p><img src={dashboardIcon} style={{ height: "13px", paddingRight: "5px" }} />
                                <Link to="/facilitatorDashboard">Home</Link> / Profile Details</p>
                        </div>
                        <div className='col'>
                    ...
                    <Row style={{ marginTop: "-27px" }}>
                        <Col>
                            <Card className="" style={{ width: "963px", marginLeft: "50px", paddingBottom: "10px", cursor: "default", color: "rgba(5,54,82,1)", fontSize: "14px" }}>
                                <div className='row'>
                                    <div className='col'>
                                        <div className='item-list' id='FacpersonalCard' style={{
                                            ...
                                            <div className='row item-list align-items-center'>
                                                <div>
                                                    <div className="row">
                                                        ...
                                                        <div className='col-lg-10 col-md-5 col-sm-6' id="Fdetail1Col">
                                                            <div className='row'>
                                        ...
                                        <div className='tab-content' style={{ backgroundColor: "rgb(240, 249, 255)" }}>
                                            <div id="address-details" className="register-form tab-pane fade show active" style={{ padding: '30px', cursor: "default" }}>
                                                <div className="row" style={{ marginTop: "-15px" }}>
                                                    <div className='col-md-10 col-lg-10' id='Faddressdetails0' style={{ fontFamily: "Poppins,sans-serif", fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                        <FaMapMarkerAlt style={{ marginTop: "-6px" }} />&nbsp;<span>Address Info</span>
                                                        <hr style={{ marginTop: "1px" }} />
                                                    </div>
                                                    <div className='col-md-2 col-lg-2' style={{ textAlign: "end" }}>
                                                        <button className='btn btn-sm'
                                                            // id="FbtnAddressdetails"
                                                ...
                                                {/* <div className="form-row" id='Faddressdetails1'>
                                            ...
                                            {this.state.address1 == "" && this.state.address2 == "" && this.state.address3 == "" && this.state.city == "" ? null :
                                                <div className='row' id='Faddressdetails2' style={{ marginTop: "-10px" }}>
                                            ...
                                            {this.state.taluk == "" && this.state.district == "" && this.state.state == "" && this.state.pincode == "" ? null :
                                                <div className='row' id='Faddressdetails3'>
                                                ...
                                                <div className="form-row" id='Faddressdetails4'>
                                                    <div className='col-4' id='headinglndwl'>
                                                        <div className="two__image" style={{ paddingLeft: "20px", marginLeft: "-10px" }}>
                                                ...
                                                {this.state.paddress1 == "" && this.state.paddress2 == "" && this.state.pstate1 == "" && this.state.pcity == "" ? "Permanent Address are empty, Please add permanent address details from edit button." :
                                                    <div className='row' id='Faddressdetails5' style={{ marginTop: "-10px" }}>
                                                ...
                                                {this.state.ptaluk == "" && this.state.pdistrict == "" && this.state.landmark == "" && this.state.ppincode == "" ? null :
                                                    <div className='row' id='Faddressdetails6'>
                                                ...
                                                <div className='row' id='Faddressdetails7' style={{ display: "none", marginTop: "-4px" }}>
                                                    ...
                                                    {/* <EditFacAddressDetails parentCallback={this.handleCallback} /> */}
                                                </div>
                                            </div>

                                            <div id="bank-details" className=" register-form tab-pane fade" style={{ padding: '30px', cursor: "default" }}>
                                                <div className="row" style={{ marginTop: "-15px" }}>
                                                    <div className='col-md-8 col-lg-10' id="Fbankdetails1" style={{ fontFamily: "Poppins,sans-serif", fontWeight: "bold", color: "RGBA(5,54,82,1)" }}>
                                                        <FaHouseUser style={{ marginTop: "-6px" }} />&nbsp;<span>Bank Info</span>
                                                        <hr style={{ marginTop: "1px" }} />
                                                    </div>
                                                    <div className='col-md-4 col-lg-2' style={{ textAlign: "end" }}>
                                                        <button className='btn btn-sm' id="FbtnBankdetails" style={{ border: "2px solid RGBA(5,54,82,1)", marginTop: "-8px" }}><FaEdit style={{ marginTop: "-4px" }} />&nbsp;<span>Edit</span></button>
                                                    </div>
                                                </div>
                                                <div className='row' id="Fbankdetails0">
                                                ...
                                                <div className='row' id="Fbankdetails2">
                                                ...
                                                <div className='row' id="Fbankdetails3">
                                                    <div className='col-sm-6 col-md-6 col-lg-3'>
                                                ...
                                                <div className='row' id='Fbankdetails4' style={{ display: "none", marginTop: "-14px" }}>
                                                    <button style={myStyle2} id="FbankdetailBtn">
                                                        <FaAngleLeft style={{ marginLeft: "-15px", color: "white", textDecoration: "none" }} /><span style={{ textDecoration: "none", color: "white" }}>Back</span>
                                                    </button>
                                                    <EditFacBankDetails parentCallback={this.handleCallback2} />
                                                </div>
                                            ...
                                            <div id="kyc-documents" className=" register-form tab-pane fade" style={{ padding: '30px', cursor: "default" }}>
                                                ...
                                                <div className="form-group">
                                                    {this.state.isVkycVerified == 0 ? <div className='pt-2'>
                                                        ...
                                                        <input type="number" className="input" name="mobile_no" id="mobile_no" placeholder="Enter Mobile Number" style={{ display: "none" }} value={sessionStorage.getItem("F_Mobile")} />
...
export default withTranslation()(FacDetails)
...
import evlPref from '../Components/assets/evlPref.svg';
import evlRef from '../Components/assets/evlRef.svg';
import loanEval from '../Components/assets/loanEval.svg';
import { confirmAlert } from 'react-confirm-alert';
import batch from '../Components/assets/batch.png';

//updated
class EvaluatorSidebar extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoggedIn: true,
    ...
    //setting some flags and storing image
                ...
                <nav className="sidenav navbar navbar-vertical p-2 fixed-left  navbar-expand-xs navbar-light bg-light d-block" id="sidebar-wrapper">
                    <div className="navbar-inner" style={{ display: "block ruby", width: "max-content" }}>
                        <div className="menu navbar-collapseOnSelect" expand="lg" id="sidenav-collapse-main">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item" id="Pinfo" style={{ width: "170px" }}>
                                    ...
                                    <button type="button" class="btn btn-sm" style={{ borderRadius: "30px", width: "140px", marginLeft: "10px", marginTop: "-10px", backgroundColor: "#0079BF" }}>
                                        <Link to="/evaluatorDetails" style={{ textDecoration: "none", color: "white", justifyContent: "center" }}>
                                            View Profile
                                        </Link>
                                    </button>
                                </li>
                                ...
                                <li className="" id='nav-items'>
                                    <Link to="/evaluatorDashboard" style={{ textDecoration: "none" }}>
                                ...
                                {/* <li className="" id='nav-items'>
                                <Link to="/evaluatorDetails" style={{ textDecoration: "none" }}>
                                    <a className="nav-link" href="#" style={{ height: "38px" }}>
                                        <CgIcons.CgProfile className="icon text-dark" style={{ marginLeft: "5px" }} />
                                        <p className="text text-dark" style={{ paddingLeft: "7px" }}>{t('Profile')}</p>
                                    </a>
                                </Link>
                            </li> */}
                                <li className="evlProfile" id='nav-items' style={{ cursor: "pointer" }}>
                                    <Link to="/evaluatorDetails" style={{ textDecoration: "none" }}>
                                ...
                                {/* <li style={{ paddingLeft: "20px", display: "none" }} id='nav-items' className="evlDocs">
                                <Link to="/evaluatorDetails" style={{ textDecoration: "none" }}>
                                    <a className="nav-link" style={{ height: "35px" }}>
                            ...
                            <li style={{ paddingLeft: "20px", display: "none" }} id='nav-items' className="evlDocs">
                                <Link to="/evlDocuments" style={{ textDecoration: "none" }}>
                                ...
                                <li className="" id='nav-items'>
                                    <Link to="/evaluatorPreference" style={{ textDecoration: "none" }}>
                                        <a className="nav-link" href="#" style={{ height: "38px" }}>
                                            <img src={evlPref} style={{ paddingLeft: "12px" }} />
                                            <p className="text text-dark" style={{ paddingLeft: "7px" }}>{t('EvaluatorPreference')}</p>
                                        </a>
                                    </Link>
                                </li>
                                <li className="" id='nav-items'>
                                    <Link to="/evaReferenceDetails" style={{ textDecoration: "none" }}>
                                        <a className="nav-link" href="#" style={{ height: "38px" }}>
                                            <img src={evlRef} style={{ paddingLeft: "12px" }} />
                                            <p className="text text-dark" style={{ paddingLeft: "16px" }}>{t('Evaluator Reference')}</p>
                                        </a>
                                    </Link>
                                </li>
                                <li className="" id='nav-items'>
                                    <Link to="/getEvaluatorLoans" style={{ textDecoration: "none" }}>
                                        <a className="nav-link" href="#" style={{ height: "38px" }}>
                                            <img src={loanEval} style={{ paddingLeft: "12px" }} />
                                            <p className="text text-dark" style={{ paddingLeft: "12px" }}>{t('LoanEvaluation')}</p>
                                        </a>
                                    </Link>
                                </li>
                                <li className="" id='nav-items'>
                                    <Link to="/evalWallet" style={{ textDecoration: "none" }}>
                                        <a className="nav-link" href="#" style={{ height: "38px" }}>
                                            <img src={escrow} style={{ paddingLeft: "12px" }} />
                                            <p className="text text-dark" style={{ paddingLeft: "7px" }}>{t('Account Details')}</p>
                                        </a>
                                    </Link>
                                </li>
                                <li className="" id='nav-items'>
                                    <Link to="/evlSupport" style={{ textDecoration: "none" }}>
                                    ...
                                    <div className='col'>
                                        ...
                                        <div style={{ border: "1.5px solid black", borderRadius: "5px", paddingTop: "10px", height: "fit-content", marginBottom: "10px" }}>
                                            <p class="text-center">
                                                ...
                                                <input type="file" name="file[]" accept=".pdf,image/*" id="attachment1012"
...
export default withTranslation()(EvaluatorSidebar)
